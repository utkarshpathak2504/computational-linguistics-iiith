...
{   document.getElementById("type1").innerHTML=" ";
    ...
    {
   document.getElementById("type1").innerHTML=c1;

    }

    else if (document.getElementById("Corpus").value=="Corpus 2")
    {
        document.getElementById("type1").innerHTML=c2;
     
         }
         else if(document.getElementById("Corpus").value=="Corpus 3" )
         {
            document.getElementById("type1").innerHTML=c3;
         }
 ...
 {
     dynEle= document.createElement(elem);
     dynELe.innerHTML = stringVal;
     document.body.appendChild(dynELe);
